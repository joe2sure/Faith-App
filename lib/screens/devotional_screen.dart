      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(left: 18), // Move second text right
              child: const Text(
                "Color",
                style: TextStyle(color: Colors.white, fontSize: 13),
              ),
...
Padding(
  padding: const EdgeInsets.symmetric(horizontal: 18), // space at the ends
  child: Container(
    height: 90,
    ...
    child: Row(
      ...
      children: [
        ...
        Row(
          children: [
            const Icon(Icons.wb_sunny, color: Colors.orange, size: 25),
            const SizedBox(width: 10),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              mainAxisAlignment: MainAxisAlignment.center,
...
Padding(
  padding: const EdgeInsets.symmetric(horizontal: 18), // Space outside container (ends)
  child: Container(
    height: 320,
    width: double.infinity,
    decoration: BoxDecoration(
    ...
    child: Column(
      ...
      children: [
        ...
        Padding(
          padding: const EdgeInsets.only(top: 18, left: 32, right: 8), // Reduce left/right padding
          child: Row(
        ...
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 2), // Reduce horizontal padding inside
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              ...
              Container(
                ...
                padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 4), // Reduce inner padding
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: const [
                    Text("6:30", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("AM", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("Daily Mass", style: TextStyle(fontSize: 10), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("Fr.", style: TextStyle(fontSize: 10), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("Martinez", style: TextStyle(fontSize: 10), textAlign: TextAlign.center),
                  ],
                ),
              ),
              const SizedBox(width: 15), // Less space between containers
              ...
              Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: const [
                    Text("12:00", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("PM", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("Noon", style: TextStyle(fontSize: 10), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("Mass", style: TextStyle(fontSize: 10), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("Fr.", style: TextStyle(fontSize: 10), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("O Connor", style: TextStyle(fontSize: 10), textAlign: TextAlign.center),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: const [
                    Text("6:00", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("PM", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("Evening", style: TextStyle(fontSize: 10), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("Mass", style: TextStyle(fontSize: 10), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("Fr", style: TextStyle(fontSize: 10), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("Johnson", style: TextStyle(fontSize: 10), textAlign: TextAlign.center),
                  ],
                ),
              ),
            ],
        ...
        Center(
          child: Container(
            ...
            child: Row(
              children: [
                const Icon(Icons.info_rounded, color: Colors.redAccent, size: 20),
                const SizedBox(width: 10),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  mainAxisAlignment: MainAxisAlignment.center,
...
const SizedBox(height: 30),
             ...
             Container(
              height: 760,
  margin: const EdgeInsets.symmetric(horizontal: 16), // space from screen edges
  decoration: BoxDecoration(
    color: Colors.white,
      ...
      Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            image: AssetImage("assets/images/Image_fx (1).jpg"), // your image
            fit: BoxFit.cover,
          ),
        ),
        child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  Padding(
  padding: const EdgeInsets.only(top: 0, right: 5, bottom: 10),
  child: Column(
    crossAxisAlignment: CrossAxisAlignment.end,
    children: [
      Text(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: const [
                    Text("6", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.green), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("This Week", style: TextStyle(fontSize: 13, color: Colors.green), textAlign: TextAlign.center),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: const [
                    Text("23", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.deepPurple), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("Day Streak", style: TextStyle(fontSize: 13, color: Colors.deepPurple), textAlign: TextAlign.center),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: const [
                    Text("98%", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.red), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("Year Goal", style: TextStyle(fontSize: 13, color: Colors.red), textAlign: TextAlign.center),
                  ],
                ),
              ),
            ],
 ...
 const SizedBox(height: 19),
  ...
  child: Container(
    ...
    child: Row(
      ...
      crossAxisAlignment: CrossAxisAlignment.center,
      children: const [
        Icon(Icons.book, color: Colors.white, size: 22), // book icon
        SizedBox(width: 8),
        Text(
        ...
        SizedBox(width: 8),
        Icon(Icons.keyboard_arrow_down, color: Colors.white, size: 22), // arrow
      ],
    ),
  ),
),
...
Padding(
  ...
  child: SingleChildScrollView(
    ...
    child: Row(
      mainAxisAlignment: MainAxisAlignment.center, // center containers
      children: [
        // Save Container
        Container(
          ...
          child: Row(
            children: const [
              ...
              SizedBox(width: 4),
              Text("Save", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16)),
            ],
          ),
        ),
      //  SizedBox(width: 12),
        ...
        Container(
          ...
          child: Row(
            children: const [
              ...
              SizedBox(width: 4),
              Text("Share", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16)),
            ],
          ),
        ),
        SizedBox(width: 12),
        ...
        Container(
          ...
          child: Row(
            children: const [
              ...
              SizedBox(width: 4),
              Text("Discuss", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold, fontSize: 16)),
            ],
          ),
        ),
      ],
...
Padding(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(fontSize: 14, color: Color.fromARGB(255, 241, 78, 70)),
                  ),
                ],
              ),
            ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: const Text("Headache Sufferers",
                      style: TextStyle(
                            color: Colors.blue,
                            fontWeight: FontWeight.bold,
                          ),
                    ...
                    Container(
                      ...
                      child: const Text("People in Religious Orders",
                      style: TextStyle(
                            color: Colors.blue,
                            fontWeight: FontWeight.bold,
                          ),
  ...
  child: Container(
    ...
    child: Row(
      ...
      crossAxisAlignment: CrossAxisAlignment.center,
      children: const [
        Icon(Icons.person, color: Colors.white, size: 22), // book icon
        SizedBox(width: 8),
        Text(
          "Read Full Biography",
          style: TextStyle(
    ...
    child: Row(
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            children: const [
              FaIcon(FontAwesomeIcons.calendar, size: 20, color: Colors.black),
              SizedBox(width: 4),
              Text("Set\nReminder", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16)),
            ],
          ),
        ),
      //  SizedBox(width: 12),
        ...
        Container(
          ...
          child: Row(
            children: const [
              ...
              SizedBox(width: 4),
              Text("Share", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold, fontSize: 16)),
            ],
          ),
        ),
        SizedBox(width: 12),
        ...
        Container(
          ...
          child: Row(
            children:  [
              FaIcon(FontAwesomeIcons.bookOpen, size: 20, color: Colors.purple),
              SizedBox(width: 4),
              Text("Learn\nMore", style: TextStyle(color: Colors.purple, fontWeight: FontWeight.bold, fontSize: 16)),
            ],
          ),
        ),
      ],
  ...
  child: Column(
    children: [
      ...
      Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text("180 minutes", style: TextStyle(color: Colors.green, fontSize: 13)),
          Text("210 minutes goal", style: TextStyle(color: Colors.green, fontSize: 13)),
        ],
      ),
    ],
  ),
...
Row(
  ...
  children: [
    ElevatedButton(
      ...
      child: Text("Start Prayer", style: TextStyle(fontSize: 15, color: Colors.white)),
    ),
    const SizedBox(width: 16),
    // Reset container
    GestureDetector(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: const [
                    Text("47m", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.green), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("Today", style: TextStyle(fontSize: 13, color: Colors.green), textAlign: TextAlign.center),
                  ],
                ),
              ),
              const SizedBox(width: 20), // Less space between containers
              ...
              Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: const [
                    Text("20m", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.deepPurple), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("Longest", style: TextStyle(fontSize: 13, color: Colors.deepPurple), textAlign: TextAlign.center),
                  ],
                ),
              ),
              const SizedBox(width: 20),
              ...
              Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: const [
                    Text("23", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.red), textAlign: TextAlign.center),
                    SizedBox(height: 2),
                    Text("Day Streak", style: TextStyle(fontSize: 13, color: Colors.red), textAlign: TextAlign.center),
                  ],
                ),
              ),
            ],
...
Container(
  ...
  child: Row(
    ...
    children: [
      Row(
        children: [
          FaIcon(FontAwesomeIcons.gear, size: 20, color: Colors.blue),
          const SizedBox(width: 8),
          Text(
            "Timer Settings",
...
Container(
  ...
  decoration: BoxDecoration(
    color: Colors.white,
    borderRadius: BorderRadius.circular(12),
    border: Border.all(color: Colors.purpleAccent), // optional border
  ...
  child: Stack(
    children: [
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(top: 0, right: 5, bottom: 8),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.end,
                  children: [
                    Text(
      ...
      Align(
        ...
        child: Padding(
          padding: const EdgeInsets.only(bottom: 10, left: 21), // adjust if needed
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
               Text(
...
DefaultTabController(
  ...
  child: Column(
    children: [
      ...
      Container(
        width: 310,
        padding: const EdgeInsets.symmetric(vertical: 6, horizontal: 6), // space around tabs
        decoration: BoxDecoration(
          color: Colors.grey.shade200,
          borderRadius: BorderRadius.circular(16),
        ),
        child: TabBar(
          ...
          tabs: [
            Container(
              ...
              child: const Text("Daily", style: TextStyle(fontSize: 15, color: Colors.black38, fontWeight: FontWeight.bold)),
            ),
            Container(
              width: 100,
              height: 40,
              alignment: Alignment.center,
              child: const Text("Weekly", style: TextStyle(fontSize: 15, color: Colors.black38, fontWeight: FontWeight.bold)),
            ),
            Container(
              width: 100,
              height: 40,
              alignment: Alignment.center,
              child: const Text("Monthly", style: TextStyle(fontSize: 15, color: Colors.black38, fontWeight: FontWeight.bold)),
            ),
          ],
        ),
      ), 
...
Container(
  ...
  child: Column(
    ...
    children: [
      ...
      Row(
        children: const [
          FaIcon(FontAwesomeIcons.lightbulb, color: Colors.black, size: 16),
          SizedBox(width: 8),
          Text(
            "Weekly Insights",
            style: TextStyle(
      ...
      Container(
        ...
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Icon(Icons.event_note, color: Colors.purple, size: 20),
            const SizedBox(width: 8),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
...
Container(
  ...
  child: Column(
    crossAxisAlignment: CrossAxisAlignment.center, // 🔹 Center the child containers
    children: [
      // 🔹 Title Row
      Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Row(
            children: [
              Container(
                margin: const EdgeInsets.only(left: 13), // 🔹 push right
      ...
      Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(bottom: 35), // 🔹 move icon slightly down
              child: Row(
                children: const [
      ...
      Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(bottom: 35), // 🔹 adjust position
              child: Row(
                children: const [
      ...
      Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(bottom: 35), // 🔹 tweak position
              child: Row(
                children: const [

...
import '../features/devotionals/challenges/challenges_screen.dart';
import '../features/devotionals/liturgical_calendar/calendar_detail_screen.dart';
import '../features/devotionals/novenas/novena_prayers_screen.dart';
import '../features/devotionals/order_of_mass/language_selection_screen.dart';
import '../features/devotionals/prayers/other_prayers_screen.dart';
import '../features/devotionals/rosary/rosary_mysteries_screen.dart';
// import '../features/order_of_mass/language_selection_screen.dart';
// import '../features/liturgical_calendar/calendar_detail_screen.dart';
// import '../features/rosary/rosary_mysteries_screen.dart';
// import '../features/novenas/novena_prayers_screen.dart';
// import '../features/prayers/other_prayers_screen.dart';
...
class _DevotionalDashboardScreenState extends State<DevotionalDashboardScreen> {
  ...
  final List<Map<String, String>> _quotes = [
    {"quote": "True Devotion is love in Action", "author": "Mother Teresa"},
    {"quote": "God loves each of us as if there were only one of us", "author": "St. Augustine"},
    {"quote": "Pray as though everything depended on God. Work as though everything depended on you.", "author": "St. Augustine"},
    {"quote": "Be who God meant you to be and you will set the world on fire.", "author": "St. Catherine of Siena"},
    {"quote": "The greatest disease in the West today is not TB or leprosy; it is being unwanted, unloved, and uncared for.", "author": "Mother Teresa"},
    {"quote": "Do not abandon yourselves to despair. We are the Easter people and hallelujah is our song.", "author": "Pope John Paul II"},
  ];
  ...
  void _updateQuote() {
    ...
    setState(() {
      _currentQuote = _quotes[randomIndex]["quote"]!;
      _currentAuthor = _quotes[randomIndex]["author"]!;
    });
  }
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildOrderOfMassSection(),
          const SizedBox(height: 25),
          _buildLiturgicalCalendarSection(),
          const SizedBox(height: 25),
          _buildRosarySection(),
          const SizedBox(height: 25),
          _buildNovenaSection(),
          const SizedBox(height: 25),
          _buildOtherPrayersSection(),
          const SizedBox(height: 25),
          _buildChallengesSection(),
          const SizedBox(height: 25),
          const SectionHeader(title: "Community Feeds", actionText: "See All"),
  ...
  Widget _buildWelcomeHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text("Deepen your prayer life today", style: AppTextStyles.h3),
          const SizedBox(height: 12),
          GestureDetector(
            onTap: _updateQuote,
            child: Container(
  ...
  Widget _buildOrderOfMassSection() {
    return Column(
      children: [
        SectionHeader(
          title: "Order of Mass",
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  "Follow along with the complete Order of Mass in your preferred language",
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 14,
                    height: 1.5,
  ...
  Widget _buildLiturgicalCalendarSection() {
    return Column(
      children: [
        SectionHeader(
          ...
          onActionTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const LiturgicalCalendarScreen()),
            );
          },
        ),
        const SizedBox(height: 12),
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "FEB",
                          style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: AppColors.primaryBlue.withOpacity(0.7)),
                        ),
                      ],
                    ),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text("Tuesday of the First Week of Lent", style: TextStyle(fontWeight: FontWeight.bold)),
                        Text("Reading I: Is 55:10-11", style: AppTextStyles.caption),
                      ],
                    ),
                  ),
      ...
      children: [
        SectionHeader(
          ...
          onActionTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const RosaryMysteriesScreen()),
            );
          },
        ),
        const SizedBox(height: 12),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.circle_outlined, color: Color(0xFF4A90E2)),
                  ),
                  const SizedBox(width: 16),
                  const Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Joyful Mysteries", style: TextStyle(fontWeight: FontWeight.bold)),
                        Text("Today: Monday", style: TextStyle(fontSize: 12, color: AppColors.textSecondary)),
                      ],
                    ),
                  ),
                  const Icon(Icons.chevron_right, color: AppColors.textSecondary),
      ...
      children: [
        SectionHeader(
          ...
          onActionTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const NovenaPrayersScreen()),
            );
          },
        ),
        const SizedBox(height: 12),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.calendar_month_outlined, color: AppColors.primaryPurple),
                  ),
                  const SizedBox(width: 16),
                  const Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Active Novenas", style: TextStyle(fontWeight: FontWeight.bold)),
                        Text("8 special prayers available", style: TextStyle(fontSize: 12, color: AppColors.textSecondary)),
                      ],
                    ),
                  ),
                  const Icon(Icons.chevron_right, color: AppColors.textSecondary),
  ...
  Widget _buildOtherPrayersSection() {
    return Column(
      children: [
        SectionHeader(
          title: "Other Prayers",
          ...
          onActionTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const OtherPrayersScreen()),
            );
          },
        ),
        const SizedBox(height: 12),
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              _buildPrayerChip("Stations of the Cross", Icons.add),
              const SizedBox(width: 12),
              _buildPrayerChip("Angelus", Icons.notifications_none),
              const SizedBox(width: 12),
              _buildPrayerChip("Divine Mercy", Icons.favorite_border),
            ],
          ),
        ),
      ],
  ...
  Widget _buildPrayerChip(String label, IconData icon) {
    return Container(
      ...
      children: [
        ...
        Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                colors: [Color(0xFF7CB798), Color(0xFF50B5B0)],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ),
              borderRadius: BorderRadius.circular(16),
              boxShadow: [
                BoxShadow(color: const Color(0xFF7CB798).withOpacity(0.3), blurRadius: 10, offset: const Offset(0, 4)),
              ],
            ),
            child: Row(
              children: [
                ...
                const Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Daily Gospel Quiz", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
                      Text("Earn 50 points today!", style: TextStyle(color: Colors.white70, fontSize: 12)),
                    ],
                  ),
                ),
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    foregroundColor: const Color(0xFF7CB798),
  ...
  Widget _buildCommunityFeedCard(Map<String, dynamic> feed) {
    final typeColor = _getFeedTypeColor(feed["type"]);
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(feed["timeAgo"], style: AppTextStyles.caption),
                    ],
                  ),
                ),
                Container(
            ...
            const SizedBox(height: 12),
            if (feed["title"] != null) ...[
              Text(feed["title"], style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
              const SizedBox(height: 4),
            ],
            Text(feed["content"], style: AppTextStyles.bodyMedium),
            const SizedBox(height: 16),
            Row(
              children: [
                _buildActionButton(
                  ...
                  label: "${feed["likes"]}",
                  color: feed["isLiked"] ? Colors.red : AppColors.textSecondary,
                  onTap: () => setState(() => feed["isLiked"] = !feed["isLiked"]),
                ),
                ...
                if (feed["type"] == "prayer_request") ...[
                  const SizedBox(width: 20),
                  _buildActionButton(
                    icon: feed["isPrayed"] ? Icons.volunteer_activism : Icons.volunteer_activism_outlined,
                    label: "${feed["prayers"]}",
                    color: feed["isPrayed"] ? AppColors.primaryBlue : AppColors.textSecondary,
                    onTap: () => setState(() => feed["isPrayed"] = !feed["isPrayed"]),
                  ),
                ],
                const Spacer(),
                IconButton(
  ...
  Color _getFeedTypeColor(String type) {
    switch (type) {
      case "prayer_request": return AppColors.primaryBlue;
      case "testimony": return const Color(0xFF7CB798);
      case "priest_post": return AppColors.primaryPurple;
  ...
  String _getFeedTypeLabel(String type) {
    switch (type) {
      ...
      case "priest_post": return "Word of God";
      default: return "Post";
    }
  }
}

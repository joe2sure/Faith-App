              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected ? const Color(0xFF0D2856) : AppColors.backgroundLight,
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(
                        color: isSelected ? const Color(0xFF0D2856) : AppColors.divider,
                      ),
                    ),
                    child: Center(
                      child: Text(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 16),
                Icon(Icons.file_download, size: 16, color: AppColors.textSecondary),
                const SizedBox(width: 4),
                Text(
